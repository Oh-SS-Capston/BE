 ...
 * {@link DocCommentSignalProvider}(4순위).
 */
public interface SemanticSignalProvider {

    /** 신호 식별자. "PACKAGE", "NAME", "DOC". 메타 키(소문자)로도 사용된다. */
    String name();
     ...
     * @param codeEdges    augmentation 시작 전 코드 엣지 스냅샷 (BFS 기반 provider 용. 현재 활성 구현체는 사용하지 않으며 확장 여지로 유지)
