...
/**
 * Reflection GraphStore shadow 후보와 Extraction Relation을
 * relation identity 및 metadata 단위로 exact 비교한다.
 */
public final class ReflectionShadowParityAnalyzer {
    ...
    private ReflectionShadowParityAnalyzer() {
    }
    ...
    public static ObservationPromotionCandidateParityReport compare(
        ...
        // reflection parity 결과는 그대로 두고 relation key map 배열/entry 중복만 줄인다.
            ...
            if (extraction == null) {
                issues.add(
                        new ObservationPromotionCandidateParityIssue(
                                ...
                                List.of(
                                        "No Extraction reflection relation "
        ...
        for (Map.Entry<String, NormalizedRelationFact> entry
            ...
            issues.add(
                    new ObservationPromotionCandidateParityIssue(
                            ...
                            null,
                            List.of(
                                    "Extraction produced a reflection "
